...
#pragma clang diagnostic pop
    ...
    if (!windowAttributesSet) {
        ...
        if (SDK_INT >= 28) {
        	//this is actually LAYOUT_IN_DISPLAY_CUTOUT_MODE_NEVER, overridden
            static const int LAYOUT_IN_DISPLAY_CUTOUT_MODE_SHORT_EDGES = 0x00000002;
...
int glfmReadFileSize(char* filename) {
    AAssetManager* assetManager = platformDataGlobal->app->activity->assetManager;
